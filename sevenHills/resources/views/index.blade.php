                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="0.1s">
                            <h4 class="h-light">Quality Healthcare is Our Specialty</h4>
                        </div>
                    ...
                    <div class="col-lg-6">
                        <div class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
                            <img src="{{  asset('img/dummy/img-1.png') }}" class="img-responsive" alt="" />
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section id="service" class="home-section nopadding paddingtop-60">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6 col-md-6">
                    <div class="wow fadeInUp" data-wow-delay="0.2s">
                        <img src="{{ asset('img/dummy/img-1.jpg') }}" class="img-responsive" alt="" />
                    </div>
                </div>
                <div class="col-sm-3 col-md-3">
                    ...
                    <div class="wow fadeInRight" data-wow-delay="0.2s">
                        <div class="service-box">
                            ...
                            <div class="service-desc">
                                <h6 class="h-light">Physician assistance</h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="wow fadeInRight" data-wow-delay="0.3s">
                        <div class="service-box">
                            ...
                            <div class="service-desc">
                                <h6 class="h-light">Medical office assistance</h6>
                            </div>
                        </div>
                    </div>
                    <div class="wow fadeInRight" data-wow-delay="0.3s">
                        <div class="service-box">
                            ...
                            <div class="service-desc">
                                <h6 class="h-light">Occupational therapy tests</h6>
                ...
                <div class="col-sm-3 col-md-3">
                    ...
                    <div class="wow fadeInRight" data-wow-delay="0.3s">
                        <div class="service-box">
                            ...
                            <div class="service-desc">
                                <h6 class="h-light">Certiﬁed nursing assistance</h6>
                            </div>
                        </div>
                    </div>
                    <div class="wow fadeInRight" data-wow-delay="0.3s">
                    ...
                    <div class="wow fadeInRight" data-wow-delay="0.3s">
                        <div class="service-box">
                            ...
                            <div class="service-desc">
                                <h6 class="h-light">Veterinarian assistance</h6>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="wow bounceInUp" data-wow-delay="0.2s">
                        <div id="owl-works" class="owl-carousel">
                            ...
                            <div class="item"><a href="{{ asset('img/photo/2.jpeg') }}" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="img/works/2@2x.jpg">
                                    <img src="img/photo/2.jpeg" class="img-responsive " alt="img"></a>
                            </div>
                            <div class="item"><a href="{{ asset('img/photo/1.jpeg') }}" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="img/works/1@2x.jpg">
                                    <img src="img/photo/1.jpeg" class="img-responsive" alt="img"></a>
                            </div>
                            <div class="item"><a href="{{ asset('img/photo/3.jpeg') }}" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="img/works/3@2x.jpg"><img src="img/photo/3.jpeg" class="img-responsive " alt="img"></a></div>
                            <div class="item"><a href="{{ asset('img/photo/4.jpeg') }}" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="img/works/4@2x.jpg"><img src="img/photo/4.jpeg" class="img-responsive " alt="img"></a></div>
                            <div class="item"><a href="{{ asset('img/photo/5.jpeg') }}" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="img/works/5@2x.jpg"><img src="img/photo/5.jpeg" class="img-responsive " alt="img"></a></div>
                            <div class="item"><a href="{{ asset('img/photo/6.jpeg') }}" title="This is an image title" data-lightbox-gallery="gallery1" data-lightbox-hidpi="img/works/6@2x.jpg"><img src="img/photo/6.jpeg" class="img-responsive " alt="img"></a></div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    {{--<div id="carousel-reviews" class="carousel slide" data-ride="carousel">--}}
                            ...
                            {{--<div class="item active">--}}
                                {{--<div class="col-md-4 col-sm-6">--}}
                                    ...
                                    {{--<div class="person-text rel text-light">--}}
                                        {{--<img src="{{ asset('img/testimonials/1.jpg') }}" alt="" class="person img-circle" />--}}
                                        {{--<a title="" href="#">Anna</a>--}}
                        ...
                        {{--<span--}}
                                {{--data-value="3" class="glyphicon glyphicon-star-empty"></span><span data-value="4" class="glyphicon glyphicon-star-empty"></span><span data-value="5" class="glyphicon glyphicon-star-empty"></span> </span>--}}
                                    ...
                                    {{--</div>--}}
                                    {{--<div class="person-text rel text-light">--}}
                                        {{--<img src="{{ asset('img/testimonials/2.jpg') }}" alt="" class="person img-circle" />--}}
                                ...
                                {{--<div class="col-md-4 col-sm-6 hidden-sm hidden-xs">--}}
                                    ...
                                    {{--</div>--}}
                                    {{--<div class="person-text rel text-light">--}}
                                        {{--<img src="{{ asset('img/testimonials/3.jpg') }}" alt="" class="person img-circle" />--}}
                            ...
                            {{--<div class="item">--}}
                                ...
                                {{--<div class="col-md-4 col-sm-6">--}}
                                    ...
                                    {{--</div>--}}
                                    {{--<div class="person-text rel text-light">--}}
                                        {{--<img src="{{ asset('img/testimonials/4.jpg') }}" alt="" class="person img-circle" />--}}
                        ...
                        {{--<span--}}
                                {{--data-value="3" class="glyphicon glyphicon-star-empty"></span><span data-value="4" class="glyphicon glyphicon-star-empty"></span><span data-value="5" class="glyphicon glyphicon-star-empty"></span> </span>--}}
                                    ...
                                    {{--</div>--}}
                                    {{--<div class="person-text rel text-light">--}}
                                        {{--<img src="{{ asset('img/testimonials/5.jpg') }}" alt="" class="person img-circle" />--}}
                                ...
                                {{--<div class="col-md-4 col-sm-6 hidden-sm hidden-xs">--}}
                                    ...
                                    {{--</div>--}}
                                    {{--<div class="person-text rel text-light">--}}
                                        {{--<img src="{{ asset('img/testimonials/6.jpg') }}" alt="" class="person img-circle" />--}}
